...
bool ShapesApp::Initialize()
{
	...
	mCamera.SetPosition(0.0f, 10.0f, -55.0f);
...
// Build tree
// Tree sprite is actually point so in this function, we are setting tree positions only
